...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var decreaseClone = decreaseBtn.cloneNode(true);
  var increaseClone = increaseBtn.cloneNode(true);
  ...
  decreaseClone.addEventListener('click', function () {
    var currentQty = parseInt(qtyInput.value);
    if (currentQty > 1) {
      qtyInput.value = currentQty - 1;
    }
  });
  increaseClone.addEventListener('click', function () {
    var currentQty = parseInt(qtyInput.value);
    qtyInput.value = currentQty + 1;
  });
  ...
  smallImages.forEach(function (img) {
    img.addEventListener('click', function () {
      ...
      var smallImageBoxes = document.querySelectorAll('.small-image-box');
      if (!mainImage) {
        console.error('Main image not found');
        return;
      }
      mainImage.src = imageSrc;
      smallImageBoxes.forEach(function (box) {
...
exports.setAuthToken = exports.handleLogout = exports.checkAuth = void 0;
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
// public/js/auth.js

var checkAuth = exports.checkAuth = function checkAuth() {
  var publicRoutes = ['/login', '/signup', '/password-reset'];
...
var handleLogout = exports.handleLogout = function handleLogout() {
  localStorage.removeItem('jwt');
  delete _axios.default.defaults.headers.common['Authorization'];
  _axios.default.get('/api/users/logout', {
    withCredentials: true
  }).catch(function () {});
  window.location.href = '/login';
};
...
_axios.default.interceptors.response.use(function (response) {
  ...
  var _error$response;
  if (((_error$response = error.response) === null || _error$response === void 0 ? void 0 : _error$response.status) === 401 && !window.location.pathname.includes('/login') && !window.location.pathname.includes('/logout')) {
